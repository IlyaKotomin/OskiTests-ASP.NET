...
namespace OskiTests.Migrations
{
    ...
    [Migration("20221206202255_Initial")]
            ...
            modelBuilder.Entity("OskiTests.Models.AnswerViewModel", b =>
                {
                    ...
                    b.Property<int?>("QuestionViewModelQuestionId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("QuestionViewModelQuestionId");
            ...
            modelBuilder.Entity("OskiTests.Models.AnswerViewModel", b =>
                {
                    b.HasOne("OskiTests.Models.QuestionViewModel", null)
                        .WithMany("Answers")
                        .HasForeignKey("QuestionViewModelQuestionId");
                });
